...
import de.avalon.utils.ReflectionUtils.PackageType;
...
public enum ParticleEffectAPI {
	...
	public static final Map<String, ParticleEffectAPI> NAME_MAP = new HashMap<String, ParticleEffectAPI>();
	public static final Map<Integer, ParticleEffectAPI> ID_MAP = new HashMap<Integer, ParticleEffectAPI>();
	...
	static {
		for (ParticleEffectAPI effect : values()) {
	 ...
	 */
	private ParticleEffectAPI(String name, int id, int requiredVersion, ParticleProperty... properties) {
		this.name = name;
		this.id = id;
	 ...
	 */
	public static ParticleEffectAPI fromName(String name) {
		for (Entry<String, ParticleEffectAPI> entry : NAME_MAP.entrySet()) {
	 ...
	 * @return The particle effect
	 */
	public static ParticleEffectAPI fromId(int id) {
		for (Entry<Integer, ParticleEffectAPI> entry : ID_MAP.entrySet()) {
			if (entry.getKey() != id) {
				continue;
			}
			return entry.getValue();
	 ...
	 */
	private static boolean isDataCorrect(ParticleEffectAPI effect, ParticleData data) {
	 ...
	 */
	private static boolean isColorCorrect(ParticleEffectAPI effect, ParticleColor color) {
	 ...
	 * @see ParticlePacket#ParticlePacket(ParticleEffectAPI, Vector, float, boolean, ParticleData)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	 ...
	 * @see ParticlePacket#ParticlePacket(ParticleEffectAPI, ParticleColor, boolean)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	...
	/**
	 * Represents the particle data for effects like {@link ParticleEffectAPI#ITEM_CRACK}, {@link ParticleEffectAPI#BLOCK_CRACK} and {@link ParticleEffectAPI#BLOCK_DUST}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the item data for the {@link ParticleEffectAPI#ITEM_CRACK} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the block data for the {@link ParticleEffectAPI#BLOCK_CRACK} and {@link ParticleEffectAPI#BLOCK_DUST} effects
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link ParticleEffectAPI#SPELL_MOB}, {@link ParticleEffectAPI#SPELL_MOB_AMBIENT}, {@link ParticleEffectAPI#REDSTONE} and {@link ParticleEffectAPI#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link ParticleEffectAPI#SPELL_MOB}, {@link ParticleEffectAPI#SPELL_MOB_AMBIENT} and {@link ParticleEffectAPI#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for the {@link ParticleEffectAPI#NOTE} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	public static final class ParticlePacket {
		...
		private final ParticleEffectAPI effect;
		 ...
		 * @see #initialize()
		 */
		public ParticlePacket(ParticleEffectAPI effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
		 ...
		 */
		public ParticlePacket(ParticleEffectAPI effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
		 ...
		 * @see #ParticleEffect(ParticleEffect, float, float, float, float, int, boolean, ParticleData)
		 */
		public ParticlePacket(ParticleEffectAPI effect, ParticleColor color, boolean longDistance) {
			this(effect, color.getValueX(), color.getValueY(), color.getValueZ(), 1, 0, longDistance, null);
			if (effect == ParticleEffectAPI.REDSTONE && color instanceof OrdinaryColor && ((OrdinaryColor) color).getRed() == 0) {
			...
			try {
				...
				if (version < 8) {
					...
					if (data != null) {
						...
						ReflectionUtils.setValue(packet, true, "k", effect == ParticleEffectAPI.ITEM_CRACK ? packetData : new int[] { packetData[0] | (packetData[1] << 12) });
					}
				}
