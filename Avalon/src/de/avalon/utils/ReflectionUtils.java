...
public final class ReflectionUtils {
	...
	public static void sendPacket(Player player, Object packet) {
		try {
			Method handleMethod = getMethod(player.getClass(), "getHandle", new Class[0]);
			Object handle = handleMethod.invoke(player, new Object[0]);
			Field field = getField(handle.getClass(), true, "playerConnection");
			Object playerConnection = field.get(handle);
			Method sendPacket = getMethod(playerConnection.getClass(), "sendPacket", getClass(PackageType.MINECRAFT_SERVER + ".Packet"));
