...
public abstract class Skill implements Cloneable {
	...
	/*Aufopferung to-do :
	 * WitherHead soll kein Damage mehr machen
	 * WitherHead soll nicht mehr explodieren (Kein Block-Damage)
	 * Player der vom WitherHead getroffen wird, wird auf 100% Leben geheilt und bekommt strange boost
	 * */
	
	public static Verzweifeltes_Gebet 	skill_verzweifeltes_gebet 		= new Verzweifeltes_Gebet("Verzweifeltes Gebet", 0, 15, 10, "In deiner Verzweiflung gibt dir das Beten neue Lebensenergie"); //Zieht komplette Mana ab
	public static Aufopferung 			skill_aufopferung 				= new Aufopferung("Aufopferung", 0, 10, 30, "Du opferst dich für einen Freund!"); //Zieht komplette Mana ab
	public static Phantom 				skill_phantom 					= new Phantom("Phantom", 80, 20, 20, "Entferne alle Bewegungseinschränkende Effekte!"); //level 20 :  20 + (20*5) = 120 Mana
